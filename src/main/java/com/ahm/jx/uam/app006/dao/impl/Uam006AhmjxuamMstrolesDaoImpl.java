 ...
 * @author george
 */
@Repository("uam006AhmjxuamMstrolesDao")
public class Uam006AhmjxuamMstrolesDaoImpl extends GenericHibernateDao<AhmjxuamMstroles, String>
        implements Uam006AhmjxuamMstrolesDao {
